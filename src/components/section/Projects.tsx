...
import { ExternalLink, Github, Database, Cpu, CheckCircle2, ArrowRight, ShieldCheck } from "lucide-react";
              ...
              <div className="space-y-4 pt-4 border-t border-slate-800/80">
                ...
                <div className="flex items-center gap-3 pt-1">
                  ...
                  <Button href="#contact" variant="ghost" size="sm">
                    Contact for Architecture Details <ArrowRight className="w-3.5 h-3.5" />
                  </Button>
                </div>
              </div>
