...
import { Calendar, Database, CheckCircle2, Zap, Award, Cloud, Server, Cpu } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {profileData.impactMetrics.map((metric, idx) => (
            <Card key={idx} hoverEffect className="space-y-3 bg-slate-900/80 border-slate-800">
              <div className="flex items-center justify-between">
                <div className="w-10 h-10 rounded-lg bg-azure-500/10 border border-azure-500/30 flex items-center justify-center text-azure-400">
                ...
                <span className="text-[10px] font-mono text-slate-500">METRIC #0{idx + 1}</span>
              </div>
              <div>
                <span className="block text-2xl font-bold text-white font-mono">{metric.value}</span>
                <span className="block text-xs font-semibold text-azure-400 mt-0.5">{metric.label}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
          <Card className="space-y-4">
            ...
            <h3 className="text-lg font-bold text-white">Azure Cloud Ecosystem</h3>
          ...
          <Card className="space-y-4">
            ...
            <h3 className="text-lg font-bold text-white">800GB+ Data Migration</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <Card className="space-y-4">
            ...
            <h3 className="text-lg font-bold text-white">AI R&D & Automation</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
